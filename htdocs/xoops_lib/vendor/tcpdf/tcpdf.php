...
require_once($DirTcpdf.'/include/tcpdf_fonts.php');
require_once($DirTcpdf.'/include/tcpdf_colors.php');
require_once($DirTcpdf.'/include/tcpdf_images.php');
require_once($DirTcpdf.'/include/tcpdf_static.php');
class TCPDF {
    protected $page;
    protected $n;
    ...
    public function MultiCell($w, $h, $txt, $border=0, $align='J', $fill=false, $ln=1, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0, $valign='T', $fitcell=false) {
        ...
        $resth = 0;
        if (($h > 0) AND $this->inPageBody() AND (((int)$y + (int)$h + (int)$mc_margin['T'] + (int)$mc_margin['B']) > $this->PageBreakTrigger)) {
    ...
    public function setFontStretching($perc=100) {
        return $this->font_stretching = $perc;
    }
    ...
    public function removePageRegion($key) {
        if (isset($this->page_regions[$key])) unset($this->page_regions[$key]);
        return '';
    }
